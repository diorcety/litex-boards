        ...
        if not self.integrated_main_ram_size:
            ...
            class EfinixDRAMBlock(InterfaceWriterBlock):
                ...
                def generate():
                    ...
                    cmd.append('design.set_property("{}","BL","BL=16 Sequential", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","CA_ODTD_CS0","Obeys ODT_CA Bond Pad", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","CA_ODT_CS0","RZQ/4", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","CA_VREF_RANGE","Range[1]", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","CA_VREF_SETTING","22.0", "DDR")'.format(name))
                    ...
                    cmd.append('design.set_property("{}","CK_ODTE_CS0","Override Disabled", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","CS_ODTE_CS0","Override Disabled", "DDR")'.format(name))
                    ...
                    cmd.append('design.set_property("{}","DBI_READ_EN","1", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","DBI_WRITE_EN","1", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","DQ_ODT_CS0","RZQ/4", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","DQ_PD_DRV_STRENGTH","34.3", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","DQ_PD_ODT","60", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","DQ_PU_DRV_STRENGTH","34.3", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","DQ_PU_ODT","Hi-Z", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","DQ_VREF_RANGE","Range[1]", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","DQ_VREF_SETTING","27.2", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","PDDS_CS0","RZQ/6", "DDR")'.format(name))
                    ...
                    cmd.append('design.set_property("{}","TCCD","8", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TCCDMW","32", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TFAW","40.0", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TPPD","4", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TRAS","42.0", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TRCD","18.0", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TRPAB","21.0", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TRPPB","18.0", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TRRD","10.0", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TRTP","7.5", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TSR","15.0", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TWR","18.0", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","TWTR","10.0", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","VREF_RANGE","Range 1", "DDR")'.format(name))
                    cmd.append('design.set_property("{}","VREF_SETTING","23.000", "DDR")'.format(name))
